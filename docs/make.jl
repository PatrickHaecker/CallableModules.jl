...
DocMeta.setdocmeta!(CallableModules, :DocTestSetup, :(using CallableModules); recursive = true)
...
makedocs(;
    modules = [CallableModules],
    authors = "Patrick Häcker <patrick.haecker@de.bosch.com>",
    repo = "https://github.com/PatrickHaecker/CallableModules.jl/blob/{commit}{path}#{line}",
    sitename = "CallableModules.jl",
    format = Documenter.HTML(; canonical = "https://PatrickHaecker.github.io/CallableModules.jl"),
    pages = list_pages(),
)

deploydocs(; repo = "github.com/PatrickHaecker/CallableModules.jl")
